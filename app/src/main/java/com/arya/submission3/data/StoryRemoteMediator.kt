...
import com.arya.submission3.data.local.room.RemoteKeys
...
class StoryRemoteMediator(private val database: StoryDatabase, private val apiService: ApiService, private val pref: UserPreferences) : RemoteMediator<Int, Story>() {
...
//                remoteKeys?.nextKey?.minus(1) ?: INITIAL_PAGE_INDEX
        ...
        try {
            val responseData = apiService.getStories(page, state.config.pageSize, 0, "Bearer ${pref.getUserToken().first()}")
